    ...
    }, E.extend = E.fn.extend = function()
    {
        ...
        for ("boolean" == typeof a && (l = a, a = arguments[s] ||
            ...
            if (null != (e = arguments[s]))
                for (t in e) r = e[t], "__proto__" !== t && a !== r && (l && r && (E.isPlainObject(r) || (i = Array.isArray(r))) ? (n = a[t], o = i && !Array.isArray(n) ? [] : i || E.isPlainObject(n) ? n :
    ...
    E.event = {
        ...
        add: function(t, e, n, r, i)
        {
            ...
            if (V(t))
            {
                ...
                while (l--) d = g = (s = be.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = E.event.special[d] ||
        ...
        dispatch: function(e)
        {
            ...
            if (u.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, u))
            {
                ...
                while ((i = a[t++]) && !u.isPropagationStopped())
                {
                    ...
                    while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped()) u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace) || (u.handleObj = o, u.data = o.data, void 0 !== (r = ((E.event.special[o.origType] ||
            ...
            return B(this, function(e)
            {
                ...
                if ("string" == typeof e && !ke.test(e) && !ge[(de.exec(e) || ["", ""])[1].toLowerCase()])
                {
                    ...
                    try
                    {
                        ...
                        {}).nodeType && (E.cleanData(ye(t, !1)), t.innerHTML = e);
                        t = 0
                    }
                    catch (e)
                    {}
    ...
    }, E.expr.pseudos.animated = function(t)
    {
        ...
        setOffset: function(e, t, n)
        {
            var r, i, o, a, s, u, l = E.css(e, "position"),
                c = E(e),
                f = {};
            "static" === l && (e.style.position = "relative"), s = c.offset(), o = E.css(e, "top"), u = E.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), m(t) && (t = t.call(e, n, E.extend(
